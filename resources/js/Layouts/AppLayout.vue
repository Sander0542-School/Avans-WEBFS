<template>
    <div>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white border-bottom sticky-top">
            <div class="container">
                <!-- Logo -->
                <inertia-link class="navbar-brand mr-4" :href="route('manager.dashboard.index')">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <jet-nav-link :href="route('manager.dashboard.index')" :active="route().current().startsWith('manager.dashboard.')">
                            Dashboard
                        </jet-nav-link>
